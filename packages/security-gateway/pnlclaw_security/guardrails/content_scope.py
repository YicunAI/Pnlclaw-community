...
_ALLOWED_TOPIC_PATTERNS: list[tuple[MessageTopic, re.Pattern[str]]] = [
    ...
    (
        MessageTopic.KNOWLEDGE_TRADING,
        re.compile(
...
_BLOCK_RESPONSES: dict[MessageTopic, str] = {
    ...
    MessageTopic.PROMPT_INJECTION: ("检测到异常输入。我是 PnLClaw 加密交易助手，无法执行与交易分析无关的指令。"),
