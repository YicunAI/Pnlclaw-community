...
class OAuthError(PnLClawError):
    ...
    def __init__(
        self, message: str = "OAuth error", details: dict[str, Any] | None = None
    ) -> None:
        super().__init__(ErrorCode.AUTHENTICATION_ERROR, message, details)
...
class AccountSuspendedError(PnLClawError):
    ...
    def __init__(
        self, message: str = "Account suspended", details: dict[str, Any] | None = None
    ) -> None:
...
class AccountBannedError(PnLClawError):
    ...
    def __init__(
        self, message: str = "Account banned", details: dict[str, Any] | None = None
    ) -> None:
        super().__init__(ErrorCode.PERMISSION_DENIED, message, details)
