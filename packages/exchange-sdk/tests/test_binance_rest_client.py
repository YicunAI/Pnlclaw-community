...
class TestBinanceErrorHandling:
    ...
    def test_rate_limit_429(self) -> None:
        ...
        with pytest.raises(RateLimitExceededError):
            client._handle_error_response(self._make_response(429, {"code": -1, "msg": "rate limit"}))

    def test_auth_error(self) -> None:
        client = _make_client()
        with pytest.raises(AuthenticationError):
            client._handle_error_response(self._make_response(401, {"code": -2015, "msg": "Invalid API key"}))
    ...
    def test_order_not_found(self) -> None:
        ...
        with pytest.raises(OrderNotFoundError):
            client._handle_error_response(self._make_response(400, {"code": -2013, "msg": "Order does not exist"}))

    def test_order_rejected(self) -> None:
        client = _make_client()
        with pytest.raises(OrderRejectedError):
            client._handle_error_response(self._make_response(400, {"code": -1013, "msg": "Filter failure"}))
